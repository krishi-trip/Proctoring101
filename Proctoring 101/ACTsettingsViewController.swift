...
class ACTsettingsViewController: UIViewController {
    ...
    */
    ...
    @objc func savePreferences() {
        defaults.set(actViewController.timings.isBigExtendedTime, forKey: "wantedACTBigTime")
        defaults.set(actViewController.timings.isSmallExtendedTime, forKey: "wantedACTSmallTime")
    }
