...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let img = UIImage(named: "icons8-time-100.png")
        let imgView = UIImageView()
        imgView.image=img
        imgView.frame.size.width = 300
        imgView.frame.size.height = 300
        imgView.contentMode = UIView.ContentMode.scaleAspectFit
        imgView.center=CGPoint(x: self.view.bounds.width*(1/2), y: self.view.bounds.height*(1/2))
        ...
        act.center=CGPoint(x: self.view.bounds.width*(1/3), y: self.view.bounds.height*(5/6))
        act.titleLabel!.font=UIFont(name: "Spartan-ExtraBold", size: 30)
        ...
        sat.center=CGPoint(x: self.view.bounds.width*(2/3), y: self.view.bounds.height*(5/6))
        sat.titleLabel!.font=UIFont(name: "Spartan-ExtraBold", size: 30)
